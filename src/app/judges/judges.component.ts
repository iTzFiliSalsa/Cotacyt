  ...
  saveAsPdf(juez: JudgesRegistered) {
    ...
    switch(this.juezActual.sede){
      case 'El mante':
        ...
        doc.text(this.juezActual.nombre, 50, 182);
      ...
      case 'Reynosa':
        ...
        doc1.text(this.juezActual.nombre, 50, 182);
        doc1.addImage('assets/image/DirectorReynosa.png', 'png', 140, 226, 36, 20);
      ...
      case 'Matamoros':
        ...
        doc2.text(this.juezActual.nombre, 50, 182);
      ...
      case 'Madero':
        ...
        doc3.text(this.juezActual.nombre, 50, 182);
      ...
      case 'Jaumave':
        ...
        doc4.text(this.juezActual.nombre, 50, 182);
      ...
      case 'Nuevo Laredo':
        ...
        doc5.text(this.juezActual.nombre, 50, 182);
      ...
      case 'Victoria':
        ...
        doc6.text(this.juezActual.nombre, 50, 182);
