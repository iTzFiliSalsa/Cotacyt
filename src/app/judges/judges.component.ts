  ...
  saveAsPdf(juez: JudgesRegistered) {
    ...
    switch(this.juezActual.sede){
      case 'El mante':
        ...
        doc.text(this.juezActual.nombre = this.titlecasePipe.transform(this.juezActual.nombre), 50, 185);
      ...
      case 'Reynosa':
        ...
        doc1.text(this.juezActual.nombre = this.titlecasePipe.transform(this.juezActual.nombre), 50, 185);
      ...
      case 'Matamoros':
        ...
        doc2.text(this.juezActual.nombre = this.titlecasePipe.transform(this.juezActual.nombre), 50, 185);
      ...
      case 'Madero':
        ...
        doc3.text(this.juezActual.nombre = this.titlecasePipe.transform(this.juezActual.nombre), 50, 185);
      ...
      case 'Jaumave':
        ...
        doc4.text(this.juezActual.nombre = this.titlecasePipe.transform(this.juezActual.nombre), 50, 185);
      ...
      case 'Nuevo Laredo':
        ...
        doc5.text(this.juezActual.nombre = this.titlecasePipe.transform(this.juezActual.nombre), 50, 185);
        doc5.save("constancia Juez "+this.juezActual.nombre+".pdf");
      break;

      case 'Victoria':
        const doc6 = new jsPDF();
        doc5.addImage('assets/image/ReconocimientoJuradoVictoria.jpg', 'jpg', 0, 0, 210, 300).setFont('Helvetica').setFontSize(28).setTextColor('#646464');
        doc5.text(this.juezActual.nombre = this.titlecasePipe.transform(this.juezActual.nombre), 50, 185);
        doc5.save("constancia Juez "+this.juezActual.nombre+".pdf");
      break;
    }
